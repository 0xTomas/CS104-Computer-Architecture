# Create dictionary to hold register numeric values.
...
# Given the function type (r, i), reg_decode() will output an
# array containing the numeric values of the registers and immediates in MIPS code.
